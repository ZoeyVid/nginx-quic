...
ARG LDFLAGS="-fuse-ld=lld -Wl,-s -Wl,-O1 -Wl,-z,nodlopen -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--as-needed -Wl,--no-copy-dt-needed-entries"
...
RUN cd /src/nginx && \
    ...
    --with-ld-opt="-fuse-ld=lld -Wl,-s -Wl,-O1 -Wl,-z,nodlopen -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--as-needed -Wl,--no-copy-dt-needed-entries" && \
# Build nginx
    make -j "$(nproc)" install && \
